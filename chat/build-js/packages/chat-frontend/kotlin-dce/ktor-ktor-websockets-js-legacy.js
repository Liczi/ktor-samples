(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlinx-coroutines-core', 'ktor-ktor-io-js-legacy', 'ktor-ktor-utils-js-legacy'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlinx-coroutines-core'), require('ktor-ktor-io-js-legacy'), require('ktor-ktor-utils-js-legacy'));
  else {
    ...
    root['ktor-ktor-websockets-js-legacy'] = factory(typeof this['ktor-ktor-websockets-js-legacy'] === 'undefined' ? {} : this['ktor-ktor-websockets-js-legacy'], kotlin, this['kotlinx-coroutines-core'], this['ktor-ktor-io-js-legacy'], this['ktor-ktor-utils-js-legacy']);
  }
}(this, function (_, Kotlin, $module$kotlinx_coroutines_core, $module$ktor_ktor_io_js_legacy, $module$ktor_ktor_utils_js_legacy) {
  'use strict';
  ...
  Object.defineProperty(DefaultWebSocketSessionImpl.prototype, 'incoming', {configurable: true, get: function () {
    return this.filtered_0;
  }});
  Object.defineProperty(DefaultWebSocketSessionImpl.prototype, 'outgoing', {configurable: true, get: function () {
    return this.outgoingToBeProcessed_0;
  }});
  Object.defineProperty(DefaultWebSocketSessionImpl.prototype, 'extensions', {configurable: true, get: function () {
    return this._extensions_0;
  }});
  Object.defineProperty(DefaultWebSocketSessionImpl.prototype, 'coroutineContext', {configurable: true, get: function () {
    return this.coroutineContext_e1jcv0$_0;
  }});
  Object.defineProperty(DefaultWebSocketSessionImpl.prototype, 'masking', {configurable: true, get: function () {
    return this.raw_0.masking;
  }, set: function (value) {
    this.raw_0.masking = value;
  }});
  Object.defineProperty(DefaultWebSocketSessionImpl.prototype, 'maxFrameSize', {configurable: true, get: function () {
    return this.raw_0.maxFrameSize;
  }, set: function (value) {
    this.raw_0.maxFrameSize = value;
  }});
  Object.defineProperty(DefaultWebSocketSessionImpl.prototype, 'pingIntervalMillis', {configurable: true, get: function () {
    return this.pingIntervalMillis_3oq8ke$_0;
  }, set: function (newValue) {
    this.pingIntervalMillis_3oq8ke$_0 = newValue;
    this.runOrCancelPinger_0();
  }});
  Object.defineProperty(DefaultWebSocketSessionImpl.prototype, 'timeoutMillis', {configurable: true, get: function () {
    return this.timeoutMillis_jqpwcu$_0;
  }, set: function (newValue) {
    this.timeoutMillis_jqpwcu$_0 = newValue;
    this.runOrCancelPinger_0();
  }});
  Object.defineProperty(DefaultWebSocketSessionImpl.prototype, 'closeReason', {configurable: true, get: function () {
  ...
  DefaultWebSocketSessionImpl.prototype.start_wwqcjq$$default = function (negotiatedExtensions) {
    if (!function (scope) {
      return scope.started_0 === false ? function () {
        scope.started_0 = true;
        return true;
      }() : false;
    }(this)) {
  ...
  Coroutine$goingAway_61zpoe$.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$flush.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$DefaultWebSocketSessionImpl$runIncomingProcessor$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
          ...
          case 14:
            ...
            if (Kotlin.isType(this.local$e, Frame$Close)) {
              ...
              if (Kotlin.isType(this.local$e, Frame$Pong)) {
                if ((tmp$_1 = this.local$this$DefaultWebSocketSessionImpl_0.pinger_0) != null) {
                  this.state_0 = 20;
  ...
  Coroutine$DefaultWebSocketSessionImpl$runOutgoingProcessor$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$outgoingProcessorLoop_0.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$sendCloseSequence_0.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  DefaultWebSocketSessionImpl.prototype.runOrCancelPinger_0 = function () {
    ...
    (tmp$_0 = function (scope) {
      var oldValue = scope.pinger_0;
      scope.pinger_0 = newPinger;
      return oldValue;
    }(this)) != null ? tmp$_0.close_dbl4no$() : null;
    ...
    if (this.closed_0 && newPinger != null) {
      this.runOrCancelPinger_0();
    }
  };
  ...
  Coroutine$checkMaxFrameSize_0.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  DefaultWebSocketSessionImpl$Companion.$metadata$ = {kind: Kind_OBJECT, simpleName: 'Companion', interfaces: []};
  ...
  DefaultWebSocketSessionImpl.$metadata$ = {kind: Kind_CLASS, simpleName: 'DefaultWebSocketSessionImpl', interfaces: [DefaultWebSocketSession, WebSocketSession]};
  ...
  Object.defineProperty(FrameTooBigException.prototype, 'message', {configurable: true, get: function () {
  ...
  FrameTooBigException.$metadata$ = {kind: Kind_CLASS, simpleName: 'FrameTooBigException', interfaces: [CopyableThrowable, Exception]};
  ...
  Coroutine$ponger$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$pinger$lambda$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$pinger$lambda$lambda_0.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 2;
            this.result_0 = this.local$closure$outgoing.send_11rb$(new Frame$Ping(encodeToByteArray(charsets.Charsets.ISO_8859_1.newEncoder(), $receiver, 0, $receiver.length)), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  Coroutine$pinger$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  WebSocketExtensionsConfig.$metadata$ = {kind: Kind_CLASS, simpleName: 'WebSocketExtensionsConfig', interfaces: []};
  ...
  WebSocketExtensionHeader.$metadata$ = {kind: Kind_CLASS, simpleName: 'WebSocketExtensionHeader', interfaces: []};
  ...
  Coroutine$send_q1ubw4$.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$close.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$closeExceptionally.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Object.defineProperty(DefaultWebSocketSessionImpl, 'Companion', {get: DefaultWebSocketSessionImpl$Companion_getInstance});
