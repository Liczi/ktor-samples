(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'kotlinx-coroutines-core', 'ktor-ktor-utils-js-legacy', 'ktor-ktor-io-js-legacy', 'ktor-ktor-events-js-legacy', 'ktor-ktor-http-js-legacy', 'ktor-ktor-http-cio-js-legacy'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('kotlinx-coroutines-core'), require('ktor-ktor-utils-js-legacy'), require('ktor-ktor-io-js-legacy'), require('ktor-ktor-events-js-legacy'), require('ktor-ktor-http-js-legacy'), require('ktor-ktor-http-cio-js-legacy'));
  else {
    ...
    root['ktor-ktor-client-core-js-legacy'] = factory(typeof this['ktor-ktor-client-core-js-legacy'] === 'undefined' ? {} : this['ktor-ktor-client-core-js-legacy'], kotlin, this['kotlinx-coroutines-core'], this['ktor-ktor-utils-js-legacy'], this['ktor-ktor-io-js-legacy'], this['ktor-ktor-events-js-legacy'], this['ktor-ktor-http-js-legacy'], this['ktor-ktor-http-cio-js-legacy']);
  }
}(this, function(_, Kotlin, $module$kotlinx_coroutines_core, $module$ktor_ktor_utils_js_legacy, $module$ktor_ktor_io_js_legacy, $module$ktor_ktor_events_js_legacy, $module$ktor_ktor_http_js_legacy, $module$ktor_ktor_http_cio_js_legacy) {
  'use strict';
  ...
  var plus_1 = $module$ktor_ktor_utils_js_legacy.io.ktor.util.date.plus_e4j7mw$;
  ...
  function HttpClient_1(engine, userConfig) {
    ...
    this.config_8be2vx$.install_dq2y33$(HttpRequestRetry$Plugin_getInstance());
  ...
  function HttpClientConfig() {
    this.plugins_0 = sharedMap();
    this.pluginConfigurations_0 = sharedMap();
  ...
  function HttpClientCall_0(client) {
    ...
    this.state_c1lcpr$_0 = new HttpClientCallState();
  ...
  var tmp$;
  var tmp$_0;
  if ((tmp$ = this.state_c1lcpr$_0.request) != null) 
    tmp$_0 = tmp$;
  else {
    throw IllegalStateException_init(('Internal error: HttpClientCall ' + this + " wasn't initialized").toString());
  }
  return tmp$_0;
}, 
  set: function(value) {
  this.state_c1lcpr$_0.request = value;
}});
  ...
  var tmp$;
  var tmp$_0;
  if ((tmp$ = this.state_c1lcpr$_0.response) != null) 
    tmp$_0 = tmp$;
  else {
    throw IllegalStateException_init(('Internal error: HttpClientCall ' + this + " wasn't initialized").toString());
  }
  ...
  set: function(value) {
  this.state_c1lcpr$_0.response = value;
}});
  ...
  HttpClientCall_0.prototype.body_qi9ur9$ = function(info_0, continuation_0, suspended) {
  ...
  if (Kotlin.isType(cause, Throwable)) {
    ...
    throw cause;
        ...
        this.local$requestData = builder.build();
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        if (this.local$$receiver.context.url.host.length === 0) {
  ...
  var url = URLBuilder(baseUrl);
  var tmp$ = requestUrl.encodedPathSegments.size > 1;
  if (tmp$) {
    tmp$ = first(requestUrl.encodedPathSegments).length === 0;
  }
  if (tmp$) {
    url.encodedPathSegments = requestUrl.encodedPathSegments;
  } else {
    var tmp$_0 = requestUrl.encodedPathSegments.size !== 1;
    if (!tmp$_0) {
      tmp$_0 = first(requestUrl.encodedPathSegments).length > 0;
    }
    if (tmp$_0) {
      url.encodedPathSegments = plus(dropLast(url.encodedPathSegments, 1), requestUrl.encodedPathSegments);
    }
  }
  url.encodedFragment = requestUrl.encodedFragment;
  url.encodedParameters = requestUrl.encodedParameters;
  takeFrom(requestUrl, url);
};
  ...
  function ResponseException(response, cachedResponseText) {
    ...
    this._response_o6ii7j$_ihvso6$_0 = threadLocal(response);
  }
  var ResponseException$_response_metadata = new PropertyMetadata('_response');
  Object.defineProperty(ResponseException.prototype, '_response_o6ii7j$_0', {
  configurable: true, 
  get: function() {
  return this._response_o6ii7j$_ihvso6$_0.getValue_lrcp0p$(this, ResponseException$_response_metadata);
}});
  ...
  var tmp$;
  var tmp$_0;
  if ((tmp$ = this._response_o6ii7j$_0) != null) 
    tmp$_0 = tmp$;
  else {
  ...
  function defaultTransformers$lambda$ObjectLiteral_0(closure$body, closure$contentLength, closure$contentType) {
    this.closure$body = closure$body;
    OutgoingContent$ReadChannelContent.call(this);
    this.contentLength_3supn9$_0 = closure$contentLength;
    this.contentType_qbp83j$_0 = closure$contentType != null ? closure$contentType : ContentType.Application.OctetStream;
  }
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        var contentLength = (tmp$_0 = this.local$$receiver.context.headers.get_61zpoe$(http.HttpHeaders.ContentLength)) != null ? toLong(tmp$_0) : null;
        if (typeof this.local$body === 'string') 
          tmp$_1 = new TextContent(this.local$body, contentType != null ? contentType : ContentType.Text.Plain);
        else if (Kotlin.isByteArray(this.local$body)) 
          tmp$_1 = new defaultTransformers$lambda$ObjectLiteral(this.local$body, contentType);
        else if (Kotlin.isType(this.local$body, ByteReadChannel)) 
          tmp$_1 = new defaultTransformers$lambda$ObjectLiteral_0(this.local$body, contentLength, contentType);
        else 
          tmp$_1 = null;
        var content = tmp$_1;
        if (content != null) {
    ...
    switch (this.state_0) {
      ...
      case 2:
        ...
        if (Kotlin.isType(cause, Throwable)) {
          ...
          this.state_0 = 3;
          this.result_0 = this.local$closure$plugin.processException_0(this.local$unwrappedCause, this);
          if (this.result_0 === COROUTINE_SUSPENDED) 
            return COROUTINE_SUSPENDED;
          continue;
        } else {
  ...
  HttpCallValidator$Companion.prototype.install_wojrb5$ = function(plugin, scope) {
  scope.requestPipeline.intercept_h71y74$(HttpRequestPipeline$Phases_getInstance().Before, HttpCallValidator$Companion$install$lambda(plugin));
  var BeforeReceive = new PipelinePhase('BeforeReceive');
  scope.responsePipeline.insertPhaseBefore_b9zzbm$(HttpResponsePipeline$Phases_getInstance().Receive, BeforeReceive);
  scope.responsePipeline.intercept_h71y74$(BeforeReceive, HttpCallValidator$Companion$install$lambda_0(plugin));
  get_0(scope, HttpSend$Plugin_getInstance()).intercept_aa8w70$(HttpCallValidator$Companion$install$lambda_1(plugin));
};
  ...
  function get_0($receiver, plugin_0) {
    var requestedPlugin = plugin($receiver, plugin_0);
    if (requestedPlugin != null) {
      return requestedPlugin;
    }
    var message = 'Plugin ' + plugin_0 + ' is not installed. Consider using `install(' + plugin_0.key + ')` in client config first.';
    throw IllegalStateException_init(message.toString());
  }
  ...
  do try {
    switch (this.state_0) {
      ...
      case 3:
        ...
        this.state_0 = 4;
        this.result_0 = this.local$$receiver.proceedWith_trkh7z$(this.local$closure$plugin.wrapContent_0(this.local$content, contentCharset), this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 4:
  ...
  scope.responsePipeline.intercept_h71y74$(HttpResponsePipeline$Phases_getInstance().Parse, HttpPlainText$Plugin$install$lambda_0(plugin));
};
  ...
  do try {
    switch (this.state_0) {
      ...
      case 2:
        ...
        if (this.local$closure$plugin.checkHttpMethod && !ALLOWED_FOR_REDIRECT.contains_11rb$(this.local$origin.request.method)) {
      ...
      case 3:
        this.state_0 = 4;
        this.result_0 = this.local$this$HttpRedirect$.handleCall_0(this.local$$receiver, this.local$context, this.local$origin, this.local$closure$plugin.allowHttpsDowngrade, this.local$closure$scope, this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 4:
  ...
  HttpRedirect$Plugin.prototype.install_wojrb5$ = function(plugin, scope) {
  get_0(scope, HttpSend$Plugin_getInstance()).intercept_aa8w70$(HttpRedirect$Plugin$install$lambda(plugin, scope, this));
};
  ...
  function HttpRequestRetry$Configuration$noRetry$lambda(f, f_0) {
    return false;
  }
  function HttpRequestRetry$Configuration$noRetry$lambda_0(f, f_0) {
    return false;
  }
  ...
  HttpRequestRetry$Configuration.prototype.retryIf_vekst7$ = function(maxRetries, block) {
  ...
  HttpRequestRetry$Configuration.prototype.retryOnExceptionIf_l1724k$ = function(maxRetries, block) {
  if (maxRetries === void 0) 
    maxRetries = -1;
  if (maxRetries !== -1) 
    this.maxRetries = maxRetries;
  ...
  function HttpRequestRetry$Configuration$retryOnException$lambda(f, cause) {
  ...
  if (maxRetries === void 0) 
    maxRetries = -1;
  this.retryOnExceptionIf_l1724k$(maxRetries, HttpRequestRetry$Configuration$retryOnException$lambda);
};
  function HttpRequestRetry$Configuration$retryOnServerErrors$lambda(f, response) {
  ...
  if (maxRetries === void 0) 
    maxRetries = -1;
  this.retryIf_vekst7$(maxRetries, HttpRequestRetry$Configuration$retryOnServerErrors$lambda);
};
  ...
  HttpRequestRetry$Configuration.prototype.delayMillis_b9hovh$ = function(block) {
  this.delayMillis_8be2vx$ = block;
};
  ...
  HttpRequestRetry$Configuration.prototype.constantDelay_3pjtqy$ = function(millis, randomizationMs) {
  if (millis === void 0) 
    millis = L1000;
  ...
  this.delayMillis_b9hovh$(HttpRequestRetry$Configuration$constantDelay$lambda(millis, randomizationMs, this));
};
  ...
  var $receiver = closure$base;
  var a = Kotlin.Long.fromNumber(JsMath.pow($receiver, retry)).multiply(L1000);
  ...
  HttpRequestRetry$Configuration.prototype.exponentialDelay_daqt14$ = function(base, maxDelayMs, randomizationMs) {
  if (base === void 0) 
    base = 2.0;
  ...
  this.delayMillis_b9hovh$(HttpRequestRetry$Configuration$exponentialDelay$lambda(base, maxDelayMs, randomizationMs, this));
};
  ...
  do try {
    switch (this.state_0) {
      ...
      case 3:
        this.local$tmp$_3 = new HttpRequestRetry$RetryEventData(this.local$subRequest, (this.local$retryCount = this.local$retryCount + 1 | 0 , this.local$retryCount), this.local$call.response, null);
        this.exceptionState_0 = 8;
        this.state_0 = 6;
        continue;
      case 4:
      ...
      case 5:
        ...
        if (Kotlin.isType(cause, Throwable)) {
          ...
          this.local$tmp$_3 = new HttpRequestRetry$RetryEventData(this.local$subRequest, (this.local$retryCount = this.local$retryCount + 1 | 0 , this.local$retryCount), null, cause);
        } else 
          throw cause;
        this.state_0 = 6;
        continue;
      case 6:
        var retryData = this.local$tmp$_3;
        this.local$closure$client.monitor.raise_asioqi$(HttpRequestRetry$Plugin_getInstance().HttpRequestRetryEvent, retryData);
        this.state_0 = 7;
        this.result_0 = this.local$this$HttpRequestRetry.delay_0(this.local$delayMillis(this.local$retryCount), this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 7:
  ...
  get_0(client, HttpSend$Plugin_getInstance()).intercept_aa8w70$(HttpRequestRetry$intercept$lambda(this, client));
};
  HttpRequestRetry.prototype.shouldRetry_1 = function(retryCount, maxRetries, shouldRetry, call) {
  return retryCount < maxRetries && shouldRetry(call.request, call.response);
};
  HttpRequestRetry.prototype.shouldRetryOnException_1 = function(retryCount, maxRetries, shouldRetry, subRequest, cause) {
  return retryCount < maxRetries && shouldRetry(subRequest, cause);
};
  ...
  function HttpSend(maxSendCount) {
    ...
    if (maxSendCount === void 0) 
      maxSendCount = 20;
    this.maxSendCount_ya8bn4$_0 = new shared$ObjectLiteral_1(maxSendCount);
  ...
  configurable: true, 
  get: function() {
  return this.maxSendCount_ya8bn4$_0.getValue_lrcp0p$(this, HttpSend$maxSendCount_metadata);
}, 
  set: function(maxSendCount) {
  this.maxSendCount_ya8bn4$_0.setValue_9rddgb$(this, HttpSend$maxSendCount_metadata, maxSendCount);
}});
  ...
  if (Kotlin.isType(cause, Throwable)) {
    ...
    throw cause;
        ...
        var realSender = new HttpSend$DefaultSender(this.local$closure$plugin.maxSendCount, this.local$closure$scope);
        var interceptedSender = {
  v: realSender};
        var tmp$_1;
  ...
  function HttpTimeout$HttpTimeoutCapabilityConfiguration() {
    ...
    this._requestTimeoutMillis_yk9qkg$_0 = new shared$ObjectLiteral_2(L0);
    this._connectTimeoutMillis_65i5np$_0 = new shared$ObjectLiteral_2(L0);
    this._socketTimeoutMillis_hq3au0$_0 = new shared$ObjectLiteral_2(L0);
  }
  ...
  configurable: true, 
  get: function() {
  return this._requestTimeoutMillis_yk9qkg$_0.getValue_lrcp0p$(this, HttpTimeout$HttpTimeoutCapabilityConfiguration$_requestTimeoutMillis_metadata);
}, 
  set: function(_requestTimeoutMillis) {
  this._requestTimeoutMillis_yk9qkg$_0.setValue_9rddgb$(this, HttpTimeout$HttpTimeoutCapabilityConfiguration$_requestTimeoutMillis_metadata, _requestTimeoutMillis);
}});
  ...
  configurable: true, 
  get: function() {
  return this._connectTimeoutMillis_65i5np$_0.getValue_lrcp0p$(this, HttpTimeout$HttpTimeoutCapabilityConfiguration$_connectTimeoutMillis_metadata);
}, 
  set: function(_connectTimeoutMillis) {
  this._connectTimeoutMillis_65i5np$_0.setValue_9rddgb$(this, HttpTimeout$HttpTimeoutCapabilityConfiguration$_connectTimeoutMillis_metadata, _connectTimeoutMillis);
}});
  ...
  configurable: true, 
  get: function() {
  return this._socketTimeoutMillis_hq3au0$_0.getValue_lrcp0p$(this, HttpTimeout$HttpTimeoutCapabilityConfiguration$_socketTimeoutMillis_metadata);
}, 
  set: function(_socketTimeoutMillis) {
  this._socketTimeoutMillis_hq3au0$_0.setValue_9rddgb$(this, HttpTimeout$HttpTimeoutCapabilityConfiguration$_socketTimeoutMillis_metadata, _socketTimeoutMillis);
}});
  ...
  function Coroutine$HttpTimeout$Plugin$install$lambda$lambda$lambda(closure$requestTimeout_0, closure$executionContext_0, this$_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
  ...
  function HttpTimeout$Plugin$install$lambda$lambda$lambda(closure$requestTimeout_0, closure$executionContext_0, this$_0) {
    return function($receiver_0, continuation_0, suspended) {
  var instance = new Coroutine$HttpTimeout$Plugin$install$lambda$lambda$lambda(closure$requestTimeout_0, closure$executionContext_0, this$_0, $receiver_0, this, continuation_0);
  if (suspended) 
    return instance;
  else 
    return instance.doResume(null);
        ...
        if (configuration != null) {
          ...
          block$break:
            do {
              ...
              var killer = launch(closure$scope, void 0, void 0, HttpTimeout$Plugin$install$lambda$lambda$lambda(requestTimeout, executionContext, this.local$$receiver));
              this.local$$receiver.context.executionContext.invokeOnCompletion_f05bi3$(HttpTimeout$Plugin$install$lambda$lambda$lambda_0(killer));
            } while (false);
          tmp$ = $receiver;
        } else 
          tmp$ = null;
  ...
  function HttpRequestTimeoutException(request) {
    var tmp$, tmp$_0;
    CancellationException_init('Request timeout has expired [url=' + request.url.buildString() + ', ' + ('request_timeout=' + ((tmp$_0 = (tmp$ = request.getCapabilityOrNull_i25mbv$(HttpTimeout$Plugin_getInstance())) != null ? tmp$.requestTimeoutMillis : null) != null ? tmp$_0 : 'unknown').toString() + ' ms]'), this);
  ...
  var cachedResponses = plus_0(this.privateStorage.findByUrl_dxu3lv$(url), this.publicStorage.findByUrl_dxu3lv$(url));
  ...
  var currentClient = tmp$_0;
  var call = new SavedHttpCall(currentClient, this.body);
  ...
  function cacheExpires($receiver, fallback) {
    ...
    if (maxAge != null) {
      return plus_1($receiver.call.response.requestTime, Kotlin.Long.fromInt(maxAge).multiply(L1000));
    }
  ...
  function Coroutine$HttpCookies$Companion$install$lambda_0(closure$plugin_0, $receiver_0, response_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$plugin = closure$plugin_0;
  ...
  function HttpCookies$Companion$install$lambda_0(closure$plugin_0) {
    return function($receiver_0, response_0, continuation_0, suspended) {
  var instance = new Coroutine$HttpCookies$Companion$install$lambda_0(closure$plugin_0, $receiver_0, response_0, this, continuation_0);
  if (suspended) 
    return instance;
  else 
    return instance.doResume(null);
  ...
  scope.sendPipeline.intercept_h71y74$(HttpSendPipeline$Phases_getInstance().State, HttpCookies$Companion$install$lambda(plugin));
  scope.receivePipeline.intercept_h71y74$(HttpReceivePipeline$Phases_getInstance().State, HttpCookies$Companion$install$lambda_0(plugin));
};
  ...
  do try {
    switch (this.state_0) {
      case 0:
        var tmp$, tmp$_0;
        if ((tmp$ = plugin(this.local$$receiver, HttpCookies$Companion_getInstance())) != null) {
          this.state_0 = 2;
  ...
  do try {
    switch (this.state_0) {
      ...
      case 2:
        ...
        var newResponse = wrapWithContent_1(this.local$response, responseContent);
        var sideResponse = wrapWithContent_0(this.local$response.call, loggingContent).response;
        launch(this.local$closure$scope, void 0, void 0, ResponseObserver$Plugin$install$lambda$lambda(this.local$closure$plugin, sideResponse));
        this.state_0 = 3;
        this.result_0 = this.local$$receiver.proceedWith_trkh7z$(newResponse, this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 3:
  ...
  return this.$delegate_qgt999$_0.send_x9o3m3$(frame, continuation);
};
  DefaultClientWebSocketSession.prototype.start_wohq5n$$default = function(negotiatedExtensions) {
  return this.$delegate_qgt999$_0.start_wohq5n$$default(negotiatedExtensions);
};
  ...
  return this.$delegate_m50m56$_0.send_x9o3m3$(frame, continuation);
};
    ...
    switch (this.state_0) {
      ...
      case 2:
        if (equals(this.local$info.type, getKClass(DefaultClientWebSocketSession))) {
          var defaultSession = this.local$closure$plugin.convertSessionToDefault_z5wamu$(this.local$session);
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        this.state_0 = 2;
        this.result_0 = (new HttpStatement($receiver, this.local$$receiver)).execute(this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 1:
  ...
  function get_2($receiver, builder, continuation) {
  ...
  function get_3($receiver, block, continuation) {
    var $receiver_1 = new HttpRequestBuilder();
    block($receiver_1);
  ...
  function get_4($receiver, urlString, block, continuation) {
    if (block === void 0) 
      block = get$lambda;
    var $receiver_1 = new HttpRequestBuilder();
    url_1($receiver_1, urlString);
  ...
  function get_5($receiver, url, block, continuation) {
    if (block === void 0) 
      block = get$lambda_0;
    var $receiver_1 = new HttpRequestBuilder();
  ...
  if ((tmp$_1 = tmp$_2) != null) {
    ...
    while (tmp$_4.hasNext()) {
      ...
      if (plugin(this.client, element_0) == null) {
  ...
  function HttpClientCallState() {
    this.request = null;
    this.response = null;
  }
  HttpClientCallState.$metadata$ = {
  kind: Kind_CLASS, 
  simpleName: 'HttpClientCallState', 
  interfaces: []};
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        var frame = tmp$;
        return this.local$this$JsWebSocketSession._incoming_0.trySend_11rb$(frame).isSuccess;
      case 1:
        throw this.exception_0;
      default:
        this.state_0 = 1;
  ...
  package$plugins.HttpCallValidator_init_gz5r9o$ = HttpCallValidator_init;
  ...
  package$plugins.get_dd3wyz$ = get_0;
  ...
  package$request.get_30bfl5$ = get_2;
  ...
  package$request.get_uxii9k$ = get_3;
  ...
  package$request.get_7cz7zq$ = get_4;
  ...
  package$request.get_9weqol$ = get_5;
  ...
  package$call.HttpClientCallState = HttpClientCallState;
  ...
  package$plugins.platformDefaultTransformers_h1fxjk$ = platformDefaultTransformers;
