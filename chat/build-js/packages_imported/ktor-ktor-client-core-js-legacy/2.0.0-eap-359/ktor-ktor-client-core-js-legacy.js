(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'kotlinx-coroutines-core', 'ktor-ktor-utils-js-legacy', 'ktor-ktor-io-js-legacy', 'ktor-ktor-events-js-legacy', 'ktor-ktor-http-js-legacy', 'ktor-ktor-websockets-js-legacy', 'ktor-ktor-serialization-js-legacy', 'ktor-ktor-websocket-serialization-js-legacy'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('kotlinx-coroutines-core'), require('ktor-ktor-utils-js-legacy'), require('ktor-ktor-io-js-legacy'), require('ktor-ktor-events-js-legacy'), require('ktor-ktor-http-js-legacy'), require('ktor-ktor-websockets-js-legacy'), require('ktor-ktor-serialization-js-legacy'), require('ktor-ktor-websocket-serialization-js-legacy'));
  else {
    ...
    root['ktor-ktor-client-core-js-legacy'] = factory(typeof this['ktor-ktor-client-core-js-legacy'] === 'undefined' ? {} : this['ktor-ktor-client-core-js-legacy'], kotlin, this['kotlinx-coroutines-core'], this['ktor-ktor-utils-js-legacy'], this['ktor-ktor-io-js-legacy'], this['ktor-ktor-events-js-legacy'], this['ktor-ktor-http-js-legacy'], this['ktor-ktor-websockets-js-legacy'], this['ktor-ktor-serialization-js-legacy'], this['ktor-ktor-websocket-serialization-js-legacy']);
  }
}(this, function(_, Kotlin, $module$kotlinx_coroutines_core, $module$ktor_ktor_utils_js_legacy, $module$ktor_ktor_io_js_legacy, $module$ktor_ktor_events_js_legacy, $module$ktor_ktor_http_js_legacy, $module$ktor_ktor_websockets_js_legacy, $module$ktor_ktor_serialization_js_legacy, $module$ktor_ktor_websocket_serialization_js_legacy) {
  'use strict';
  ...
  appendAll($receiver, url.encodedParameters);
  var defaultParameters = $receiver;
  url.encodedParameters = requestUrl.encodedParameters;
  var tmp$_1;
  tmp$_1 = defaultParameters.entries().iterator();
  while (tmp$_1.hasNext()) {
    var element = tmp$_1.next();
    var key = element.key;
    var values = element.value;
    if (!url.encodedParameters.contains_61zpoe$(key)) {
      url.encodedParameters.appendAll_poujtz$(key, values);
    }
  }
  ...
  function Coroutine$HttpCallValidator$Companion$install$lambda(closure$plugin_0, closure$scope_0, $receiver_0, it_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 6;
    this.local$closure$plugin = closure$plugin_0;
    ...
    switch (this.state_0) {
      ...
      case 2:
        ...
        if (Kotlin.isType(cause, Throwable)) {
          ...
          this.state_0 = 3;
          this.result_0 = this.local$closure$plugin.processException_0(this.local$unwrappedCause, new DefaultHttpRequest(new HttpClientCall(this.local$closure$scope), this.local$$receiver.context.build()), this);
          if (this.result_0 === COROUTINE_SUSPENDED) 
            return COROUTINE_SUSPENDED;
          continue;
        } else {
  ...
  function HttpCallValidator$Companion$install$lambda(closure$plugin_0, closure$scope_0) {
    return function($receiver_0, it_0, continuation_0, suspended) {
  var instance = new Coroutine$HttpCallValidator$Companion$install$lambda(closure$plugin_0, closure$scope_0, $receiver_0, it_0, this, continuation_0);
  if (suspended) 
    return instance;
  else 
    return instance.doResume(null);
  ...
  scope.requestPipeline.intercept_h71y74$(HttpRequestPipeline$Phases_getInstance().Before, HttpCallValidator$Companion$install$lambda(plugin_0, scope));
  ...
  do try {
    switch (this.state_0) {
      ...
      case 1:
        throw this.exception_0;
      case 2:
        var cause = new HttpRequestTimeoutException(this.local$closure$context);
  ...
  function HttpRequestTimeoutException(request) {
    var tmp$, tmp$_0;
    IOException_init('Request timeout has expired [url=' + request.url.buildString() + ', ' + ('request_timeout=' + ((tmp$_0 = (tmp$ = request.getCapabilityOrNull_i25mbv$(HttpTimeout$Plugin_getInstance())) != null ? tmp$.requestTimeoutMillis : null) != null ? tmp$_0 : 'unknown').toString() + ' ms]'), this);
  ...
  do try {
    switch (this.state_0) {
      ...
      case 2:
        ...
        var loggingContent = tmp$_2.component1(), responseContent = tmp$_2.component2();
        this.local$newResponse = wrapWithContent_1(this.local$response, responseContent);
