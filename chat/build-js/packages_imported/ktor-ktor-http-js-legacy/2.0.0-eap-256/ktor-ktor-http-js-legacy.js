(function(root, factory) {
  ...
  var caseInsensitiveMap = $module$ktor_ktor_utils_js_legacy.io.ktor.util.caseInsensitiveMap_287e2$;
  ...
  if (this.parameters.isEmpty()) 
    ...
    tmp$_1 = this.parameters.iterator();
    while (tmp$_1.hasNext()) {
      var element_0 = tmp$_1.next();
      var name = element_0.component1(), value = element_0.component2();
      $receiver.append_pdl1vj$('; ');
  ...
  function isQuoted($receiver) {
    ...
    if (first($receiver) !== 34 || last($receiver) !== 34) {
      return false;
    }
    var startIndex = 1;
    do {
      var index = indexOf($receiver, 34, startIndex);
      if (index === get_lastIndex($receiver)) {
        break;
      }
      var slashesCount = 0;
  ...
  function nextIsSemicolonOrEnd($receiver, start) {
    ...
    loop:
      while (position < $receiver.length && $receiver.charCodeAt(position) === 32) {
        position = position + 1 | 0;
      }
  ...
  function HttpHeaders() {
    ...
    this.XForwardedPort_8be2vx$ = 'X-Forwarded-Port';
  ...
  function mergeRangesKeepOrder($receiver) {
    ...
    while (tmp$_0.hasNext()) {
      ...
      else if (last_0(acc).endInclusive.compareTo_11rb$(element.start.subtract(Kotlin.Long.fromInt(1))) < 0) 
        acc.add_11rb$(element);
      else {
        var last = last_0(acc);
        var tmp$_1 = get_lastIndex_0(acc);
        var tmp$_2 = last.start;
        var a = last.endInclusive;
  ...
  function URLBuilder(protocol, host, port, user, password, pathSegments, parameters, fragment, trailingQuery) {
    ...
    this.encodedPathSegments_6bxoyr$_0 = destination;
  ...
  Object.defineProperty(URLBuilder.prototype, 'encodedPathSegments', {
  configurable: true, 
  get: function() {
  return this.encodedPathSegments_6bxoyr$_0;
}, 
  set: function(value) {
  this.encodedPathSegments_6bxoyr$_0 = value.isEmpty() ? listOf_0('') : value;
}});
  ...
  var tmp$;
  this.applyOrigin_0();
  var tmp$_0 = this.pathSegments.size > 1;
  if (tmp$_0) {
    tmp$_0 = first_0(this.pathSegments).length === 0;
  }
  if (tmp$_0) 
    tmp$ = drop(this.pathSegments, 1);
  else 
    tmp$ = this.pathSegments;
  var pathSegments = tmp$;
  return new Url_1(this.protocol, this.host, this.port, pathSegments, this.parameters.build(), this.fragment, this.user, this.password, this.trailingQuery, this.buildString());
};
  ...
  function appendPathSegments($receiver, segments) {
      ...
      while (tmp$.hasNext()) {
        ...
        dropWhile$break:
          do {
            ...
            tmp$_1 = get_indices(item);
            tmp$_0_0 = tmp$_1.first;
            tmp$_1_0 = tmp$_1.last;
            tmp$_2 = tmp$_1.step;
            for (var index = tmp$_0_0; index <= tmp$_1_0; index += tmp$_2) {
              if (!(unboxChar(toBoxedChar(item.charCodeAt(index))) === 47)) {
                dropWhile$result = item.substring(index);
                break dropWhile$break;
              }
            }
            dropWhile$result = '';
          } while (false);
        var $receiver_0 = dropWhile$result;
        var dropLastWhile$result;
        dropLastWhile$break:
          do {
            for (var index_0 = get_lastIndex($receiver_0); index_0 >= 0; index_0--) {
              if (!(unboxChar(toBoxedChar($receiver_0.charCodeAt(index_0))) === 47)) {
                dropLastWhile$result = $receiver_0.substring(0, index_0 + 1 | 0);
                break dropLastWhile$break;
              }
            }
            dropLastWhile$result = '';
          } while (false);
        tmp$_0.call(destination, encodeURLPath(dropLastWhile$result));
      }
    var destination_0 = ArrayList_init_0();
    var tmp$_3;
    ...
    var paths = destination_0;
    $receiver.encodedPathSegments = plus_0($receiver.encodedPathSegments, paths);
    return $receiver;
  }
  ...
  function appendEncodedPathSegments($receiver, segments) {
    ...
    loop_label:
      while (tmp$.hasNext()) {
        ...
        tmp$_0.call(destination, dropLastWhile$result);
      }
    var destination_0 = ArrayList_init_0();
    var tmp$_3;
    tmp$_3 = destination.iterator();
  ...
  function get_encodedPath($receiver) {
    var path = joinToString($receiver.encodedPathSegments, '/');
    return startsWith_0(path, 47) ? path : '/' + path;
  }
  function set_encodedPath($receiver, value) {
    $receiver.encodedPathSegments = toMutableList(split_0(value, Kotlin.charArrayOf(47)));
  }
  ...
  function takeFromUnsafe($receiver, urlString) {
    ...
    if (startIndex >= endIndex) {
      $receiver.encodedPathSegments = urlString.charCodeAt(endIndex - 1 | 0) === 47 ? listOf(['', '']) : listOf_0('');
      return $receiver;
    }
    if (slashCount === 0) {
    ...
    if (pathEnd > startIndex) {
      ...
      if (slashCount === 1) 
        ...
        tmp$_3 = emptyList();
      var relativePath = plus_0(tmp$_3, split_0(rawPath, Kotlin.charArrayOf(47)));
  ...
  function Url$encodedQuery$lambda(this$Url) {
    return function() {
  if (this$Url.parameters.isEmpty()) {
    return '';
  }
