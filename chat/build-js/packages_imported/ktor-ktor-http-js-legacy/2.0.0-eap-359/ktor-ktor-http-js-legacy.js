(function(root, factory) {
  ...
  function appendPathSegments($receiver, segments) {
    ...
    appendEncodedPathSegments($receiver, destination);
    return $receiver;
  }
  ...
  function appendEncodedPathSegments($receiver, segments) {
    ...
    loop_label:
      while (tmp$_0.hasNext()) {
        ...
        dropLastWhile$break:
          do {
            for (var index_0 = get_lastIndex_0($receiver_0); index_0 >= 0; index_0--) {
        ...
        tmp$_1.call(destination, dropLastWhile$result);
      }
    var destination_0 = ArrayList_init_0();
    var tmp$_3;
    ...
    var $receiver_1 = $receiver.encodedPathSegments;
    var all$result;
    all$break:
      do {
        var tmp$_4;
    ...
    if (all$result) {
      tmp$ = plus_0(listOf_0(''), paths);
    } else {
      tmp$ = plus_0($receiver.encodedPathSegments, paths);
    }
  ...
  function websocketServerAccept(nonce) {
    ...
    return encodeBase64_0(sha1(encodeToByteArray(charsets.Charsets.ISO_8859_1.newEncoder(), $receiver, 0, $receiver.length)));
  }
