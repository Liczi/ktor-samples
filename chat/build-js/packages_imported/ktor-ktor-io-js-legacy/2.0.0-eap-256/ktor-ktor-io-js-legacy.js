(function(root, factory) {
  ...
  if (!(instance !== ChunkBuffer$Companion_getInstance().Empty)) {
    var message = "ChunkBuffer.Empty couldn't be recycled";
    throw IllegalStateException_init(message.toString());
  }
  ...
  if (!(instance.referenceCount === 0)) {
    var message_1 = 'Unable to clear buffer: it is still in use.';
    throw IllegalStateException_init(message_1.toString());
  }
  if (!(instance.next == null)) {
    var message_2 = "Recycled instance shouldn't be a part of a chain.";
    throw IllegalStateException_init(message_2.toString());
  }
  if (!(instance.origin == null)) {
    var message_3 = "Recycled instance shouldn't be a view or another buffer.";
  ...
  interfaces: [Exception]};
  var buildPacket = defineInlineFunction('ktor-ktor-io-js-legacy.io.ktor.utils.io.core.buildPacket_1pjhv2$', wrapFunction(function() {
  var BytePacketBuilder = _.io.ktor.utils.io.core.BytePacketBuilder_za3lpa$;
  var Throwable = Error;
  ...
  function Input(head, remaining, pool) {
    ...
    if (pool === void 0) 
      pool = ChunkBuffer$Companion_getInstance().Pool;
    this.pool = pool;
    this.state_ptxuln$_0 = new InputSharedState(head, remaining);
    this.noMoreChunksAvailable_qul5an$_0 = false;
  }
  Object.defineProperty(Input.prototype, 'endOfInput', {
  configurable: true, 
  get: function() {
  return (this.headEndExclusive - this.headPosition | 0) === 0 && equals(this.tailRemaining_kvq7my$_0, L0) && (this.noMoreChunksAvailable_qul5an$_0 || this.doFill_9l192i$_0() == null);
}});
  Object.defineProperty(Input.prototype, '_head_g6i1fh$_0', {
  configurable: true, 
  get: function() {
  return this.state_ptxuln$_0.head;
}, 
  set: function(newHead) {
  this.state_ptxuln$_0.head = newHead;
  this.state_ptxuln$_0.headMemory = newHead.memory;
  this.state_ptxuln$_0.headPosition = newHead.readPosition;
  this.state_ptxuln$_0.headEndExclusive = newHead.writePosition;
}});
  ...
  Object.defineProperty(Input.prototype, 'headMemory', {
  configurable: true, 
  get: function() {
  return this.state_ptxuln$_0.headMemory;
}, 
  set: function(value) {
  this.state_ptxuln$_0.headMemory = value;
}});
  Object.defineProperty(Input.prototype, 'headPosition', {
  configurable: true, 
  get: function() {
  return this.state_ptxuln$_0.headPosition;
}, 
  set: function(value) {
  this.state_ptxuln$_0.headPosition = value;
}});
  Object.defineProperty(Input.prototype, 'headEndExclusive', {
  configurable: true, 
  get: function() {
  return this.state_ptxuln$_0.headEndExclusive;
}, 
  set: function(value) {
  this.state_ptxuln$_0.headEndExclusive = value;
}});
  ...
  Object.defineProperty(Input.prototype, 'tailRemaining_kvq7my$_0', {
  configurable: true, 
  get: function() {
  return this.state_ptxuln$_0.tailRemaining;
}, 
  ...
  this.state_ptxuln$_0.tailRemaining = newValue;
}});
  Input.prototype.prefetch_8e33dg$ = function(min) {
  if (min.toNumber() <= 0) 
    return true;
  var headRemaining = this.headEndExclusive - this.headPosition | 0;
  if (headRemaining >= min.toNumber() || Kotlin.Long.fromInt(headRemaining).add(this.tailRemaining_kvq7my$_0).compareTo_11rb$(min) >= 0) 
    return true;
  ...
  var available = Kotlin.Long.fromInt(this.headEndExclusive - this.headPosition | 0).add(this.tailRemaining_kvq7my$_0);
  do {
    var next = this.fill();
    if (next == null) {
    ...
    if (tail === ChunkBuffer$Companion_getInstance().Empty) {
      ...
      tail.next = next;
      this.tailRemaining_kvq7my$_0 = this.tailRemaining_kvq7my$_0.add(Kotlin.Long.fromInt(chunkSize));
    }
  ...
  configurable: true, 
  get: function() {
  return Kotlin.Long.fromInt(this.headEndExclusive - this.headPosition | 0).add(this.tailRemaining_kvq7my$_0);
}});
  Input.prototype.canRead = function() {
  return this.headPosition !== this.headEndExclusive || !equals(this.tailRemaining_kvq7my$_0, L0);
};
  Input.prototype.hasBytes_za3lpa$ = function(n) {
  return Kotlin.Long.fromInt(this.headEndExclusive - this.headPosition | 0).add(this.tailRemaining_kvq7my$_0).toNumber() >= n;
};
  ...
  if (head !== empty) {
    ...
    this.tailRemaining_kvq7my$_0 = L0;
  ...
  if (next == null) {
    ...
    this._head_g6i1fh$_0 = next;
    this.tailRemaining_kvq7my$_0 = this.tailRemaining_kvq7my$_0.subtract(Kotlin.Long.fromInt(next.writePosition - next.readPosition | 0));
  }
  head.next = null;
  return head;
};
  ...
  if (this._head_g6i1fh$_0 === ChunkBuffer$Companion_getInstance().Empty) {
    ...
    this.tailRemaining_kvq7my$_0 = size.subtract(Kotlin.Long.fromInt(this.headEndExclusive - this.headPosition | 0));
  } else {
    findTail(this._head_g6i1fh$_0).next = chain;
    this.tailRemaining_kvq7my$_0 = this.tailRemaining_kvq7my$_0.add(size);
  }
};
  ...
  if (this.head === tail) {
    ...
    this.tailRemaining_kvq7my$_0 = this.tailRemaining_kvq7my$_0.add(Kotlin.Long.fromInt(size));
  }
  return true;
};
  ...
  if (equals(this.tailRemaining_kvq7my$_0, L0) && this.noMoreChunksAvailable_qul5an$_0) 
    return -1;
  ...
  if (remaining > overrunSize) {
    ...
    this.tailRemaining_kvq7my$_0 = this.tailRemaining_kvq7my$_0.add(Kotlin.Long.fromInt(overrunSize));
  } else {
    this._head_g6i1fh$_0 = next;
    this.tailRemaining_kvq7my$_0 = this.tailRemaining_kvq7my$_0.subtract(Kotlin.Long.fromInt((next.writePosition - next.readPosition | 0) - overrunSize | 0));
    current.cleanNext();
  ...
  this.tailRemaining_kvq7my$_0 = remainingAll(chunk2);
};
  ...
  if (tail === ChunkBuffer$Companion_getInstance().Empty) {
    ...
    if (!equals(this.tailRemaining_kvq7my$_0, L0)) {
      throw IllegalStateException_init('It should be no tail remaining bytes if current tail is EmptyBuffer');
    }
    this.tailRemaining_kvq7my$_0 = (tmp$_0 = (tmp$ = chunk.next) != null ? remainingAll(tmp$) : null) != null ? tmp$_0 : L0;
  } else {
    tail.next = chunk;
    this.tailRemaining_kvq7my$_0 = this.tailRemaining_kvq7my$_0.add(remainingAll(chunk));
  }
};
  ...
  if (headSize === 0) {
    ...
    this.tailRemaining_kvq7my$_0 = this.tailRemaining_kvq7my$_0.subtract(Kotlin.Long.fromInt(copied));
    if (!(next.writePosition > next.readPosition)) {
      head.next = null;
  ...
  function Output(headerSizeHint, pool) {
    if (headerSizeHint === void 0) 
      headerSizeHint = 0;
    this.headerSizeHint_4fkpcm$_0 = headerSizeHint;
    this.pool = pool;
    this.state_p19i6w$_0 = new OutputSharedState();
  }
  ...
  Object.defineProperty(Output.prototype, '_head_fdtp0q$_0', {
  configurable: true, 
  get: function() {
  return this.state_p19i6w$_0.head;
}, 
  set: function(value) {
  this.state_p19i6w$_0.head = value;
}});
  Object.defineProperty(Output.prototype, '_tail_fkcube$_0', {
  configurable: true, 
  get: function() {
  return this.state_p19i6w$_0.tail;
}, 
  set: function(value) {
  this.state_p19i6w$_0.tail = value;
}});
  ...
  Object.defineProperty(Output.prototype, 'tailMemory_8be2vx$', {
  configurable: true, 
  get: function() {
  return this.state_p19i6w$_0.tailMemory;
}, 
  set: function(value) {
  this.state_p19i6w$_0.tailMemory = value;
}});
  Object.defineProperty(Output.prototype, 'tailPosition_8be2vx$', {
  configurable: true, 
  get: function() {
  return this.state_p19i6w$_0.tailPosition;
}, 
  set: function(value) {
  this.state_p19i6w$_0.tailPosition = value;
}});
  Object.defineProperty(Output.prototype, 'tailEndExclusive_8be2vx$', {
  configurable: true, 
  get: function() {
  return this.state_p19i6w$_0.tailEndExclusive;
}, 
  set: function(value) {
  this.state_p19i6w$_0.tailEndExclusive = value;
}});
  Object.defineProperty(Output.prototype, 'tailInitialPosition_9teb5g$_0', {
  configurable: true, 
  get: function() {
  return this.state_p19i6w$_0.tailInitialPosition;
}, 
  set: function(value) {
  this.state_p19i6w$_0.tailInitialPosition = value;
}});
  Object.defineProperty(Output.prototype, 'chainedSize_k37a08$_0', {
  configurable: true, 
  get: function() {
  return this.state_p19i6w$_0.chainedSize;
}, 
  set: function(value) {
  this.state_p19i6w$_0.chainedSize = value;
}});
  ...
  if (head !== ChunkBuffer$Companion_getInstance().Empty) {
    ...
    head.resetForWrite();
    head.reserveStartGap_za3lpa$(this.headerSizeHint_4fkpcm$_0);
  ...
  function Output_init(pool, $this) {
    $this = $this || Object.create(Output.prototype);
    Output.call($this, 0, pool);
    return $this;
  }
  function Output_init_0($this) {
    $this = $this || Object.create(Output.prototype);
    Output_init(ChunkBuffer$Companion_getInstance().Pool, $this);
    return $this;
  }
  ...
  configurable: true, 
  get: defineInlineFunction('ktor-ktor-io-js-legacy.io.ktor.utils.io.core.internal.EncodeResult.get_characters', wrapFunction(function() {
  var toShort = Kotlin.toShort;
  var UShort_init = Kotlin.kotlin.UShort;
  return function() {
  ...
  configurable: true, 
  get: defineInlineFunction('ktor-ktor-io-js-legacy.io.ktor.utils.io.core.internal.EncodeResult.get_bytes', wrapFunction(function() {
  var toShort = Kotlin.toShort;
  var UShort_init = Kotlin.kotlin.UShort;
  return function() {
    ...
    switch (this.state_0) {
      case 0:
        ...
        if (this.$this.readable.endOfInput) {
          ...
          this.local$tmp$_0 = readAvailable_24(this.$this.readable, this.local$dst, this.local$offset, this.local$length);
          this.state_0 = 3;
          continue;
        }
      case 1:
  ...
  function preventFreeze($receiver) {
  }
  ...
  var shared = defineInlineFunction('ktor-ktor-io-js-legacy.io.ktor.utils.io.concurrent.shared_mh5how$', wrapFunction(function() {
  var Kind_CLASS = Kotlin.Kind.CLASS;
  var ReadWriteProperty = Kotlin.kotlin.properties.ReadWriteProperty;
  function shared$ObjectLiteral(closure$value) {
    this.value_0 = closure$value;
  ...
  return new shared$ObjectLiteral(value);
};
}));
  ...
  function InputSharedState(head, remaining) {
    this.head = head;
  ...
  InputSharedState.$metadata$ = {
  kind: Kind_CLASS, 
  simpleName: 'InputSharedState', 
  interfaces: []};
  function OutputSharedState() {
    this.head = null;
    this.tail = null;
  ...
  OutputSharedState.$metadata$ = {
  kind: Kind_CLASS, 
  simpleName: 'OutputSharedState', 
  interfaces: []};
  ...
  var memory = $receiver.memory;
  var start = $receiver.writePosition;
  var rc = block(memory.slice_vux9f0$(start, $receiver.limit - start | 0).view);
  $receiver.commitWritten_za3lpa$(rc);
  return rc;
});
  ...
  var memory = $receiver.memory;
  var start = $receiver.readPosition;
  var rc = block(memory.slice_vux9f0$(start, $receiver.writePosition - start | 0).view);
  $receiver.discardExact_za3lpa$(rc);
  return rc;
});
  ...
  package$core.Output_init_2bs5fo$ = Output_init;
  package$core.Output_init = Output_init_0;
  ...
  package$internal.decodeUTF8LineLoopSuspend_l2uygi$ = decodeUTF8LineLoopSuspend;
  ...
  package$io_0.preventFreeze_s8jyvk$ = preventFreeze;
  ...
  package$core.InputSharedState = InputSharedState;
  package$core.OutputSharedState = OutputSharedState;
