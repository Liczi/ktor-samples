(function(root, factory) {
  ...
  function ByteChannelSequentialBase(initial, autoFlush, pool) {
    ...
    this._lastReadView_api77i$_0 = ChunkBuffer$Companion_getInstance().Empty;
    this._totalBytesRead_mx8dwu$_0 = L0;
    this._totalBytesWritten_s86f3f$_0 = L0;
    this.closed_nd5qzq$_0 = false;
    this.writable = new BytePacketBuilder(pool);
    this.readable = ByteReadPacket_init(initial, pool);
    this.lastReadAvailable_1j890x$_fakn2m$_0 = 0;
    this.lastReadView_92ta1h$_nlevyr$_0 = ChunkBuffer$Companion_getInstance().Empty;
  ...
  configurable: true, 
  get: function() {
  return this.closed_nd5qzq$_0;
}, 
  set: function(closed) {
  this.closed_nd5qzq$_0 = closed;
}});
  Object.defineProperty(ByteChannelSequentialBase.prototype, 'lastReadAvailable_1j890x$_0', {
  configurable: true, 
  get: function() {
  return this.lastReadAvailable_1j890x$_fakn2m$_0;
}, 
  set: function(lastReadAvailable) {
  this.lastReadAvailable_1j890x$_fakn2m$_0 = lastReadAvailable;
}});
  Object.defineProperty(ByteChannelSequentialBase.prototype, 'lastReadView_92ta1h$_0', {
  configurable: true, 
  get: function() {
  return this.lastReadView_92ta1h$_nlevyr$_0;
}, 
  set: function(lastReadView) {
  this.lastReadView_92ta1h$_nlevyr$_0 = lastReadView;
}});
  ...
  configurable: true, 
  get: function() {
  return this._totalBytesRead_mx8dwu$_0;
}});
  Object.defineProperty(ByteChannelSequentialBase.prototype, 'totalBytesWritten', {
  configurable: true, 
  get: function() {
  return this._totalBytesWritten_s86f3f$_0;
}});
  ...
  (function(scope) {
  scope._totalBytesRead_mx8dwu$_0 = scope._totalBytesRead_mx8dwu$_0.add(Kotlin.Long.fromInt(count));
  return scope._totalBytesRead_mx8dwu$_0;
})(this);
};
  ByteChannelSequentialBase.prototype.addBytesWritten_9dtw3h$_0 = function(count) {
  (function(scope) {
  scope._totalBytesWritten_s86f3f$_0 = scope._totalBytesWritten_s86f3f$_0.add(Kotlin.Long.fromInt(count));
  return scope._totalBytesWritten_s86f3f$_0;
})(this);
};
...
})(this) && this.local$sleepCondition()) {
