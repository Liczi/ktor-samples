(function(root, factory) {
  ...
  EquatableAttributeKey.prototype = Object.create(AttributeKey.prototype);
  EquatableAttributeKey.prototype.constructor = EquatableAttributeKey;
  ...
  interfaces: []};
  function EquatableAttributeKey(name) {
    AttributeKey.call(this, name);
  }
  EquatableAttributeKey.prototype.equals = function(other) {
  var tmp$, tmp$_0;
  if (this === other) 
    return true;
  if (other == null || !((tmp$ = Kotlin.getKClassFromExpression(this)) != null ? tmp$.equals(Kotlin.getKClassFromExpression(other)) : null)) 
    return false;
    Kotlin.isType(tmp$_0 = other, EquatableAttributeKey) ? tmp$_0 : throwCCE();
  if (!equals(this.name, other.name)) 
    return false;
  return true;
};
  EquatableAttributeKey.prototype.hashCode = function() {
  return hashCode(this.name);
};
  EquatableAttributeKey.$metadata$ = {
  kind: Kind_CLASS, 
  simpleName: 'EquatableAttributeKey', 
  interfaces: [AttributeKey]};
  function Attributes() {
  }
  ...
  var list = this.ensureListForKey_4daw8w$_0(name, 1);
  list.clear();
  list.add_11rb$(value);
};
  ...
  this.validateValue_61zpoe$(value);
  this.ensureListForKey_4daw8w$_0(name, 1).add_11rb$(value);
};
  ...
  var list = this.ensureListForKey_4daw8w$_0(name, (tmp$_1 = (tmp$_0 = Kotlin.isType(tmp$ = values, Collection) ? tmp$ : null) != null ? tmp$_0.size : null) != null ? tmp$_1 : 2);
  var tmp$_2;
  ...
  StringValuesBuilderImpl.prototype.ensureListForKey_4daw8w$_0 = function(name, size) {
  var tmp$;
  var tmp$_0;
  ...
  function Coroutine$addToContextInDebugMode(elements_0, block_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$elements = elements_0;
  ...
  do try {
    switch (this.state_0) {
      ...
      case 3:
        ...
        var tmp$;
        var accumulator = this.result_0;
        for (tmp$ = 0; tmp$ !== this.local$elements.length; ++tmp$) {
          var element = this.local$elements[tmp$];
          accumulator = accumulator.plus_1fupul$(element);
        }
        var debugContext = accumulator;
        this.state_0 = 4;
  ...
  function addToContextInDebugMode(elements_0, block_0, continuation_0, suspended) {
    var instance = new Coroutine$addToContextInDebugMode(elements_0, block_0, continuation_0);
    if (suspended) 
      return instance;
    else 
      return instance.doResume(null);
  ...
  do try {
    switch (this.state_0) {
      case 0:
        this.state_0 = 2;
        this.result_0 = addToContextInDebugMode([new PluginsTrace()], execute$lambda(this.local$context, this.local$$receiver), this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 1:
  ...
  var COROUTINE_SUSPENDED = Kotlin.kotlin.coroutines.intrinsics.COROUTINE_SUSPENDED;
  var CoroutineImpl = Kotlin.kotlin.coroutines.CoroutineImpl;
  var PluginsTrace_init = _.io.ktor.util.debug.plugins.PluginsTrace;
  var Unit = Kotlin.kotlin.Unit;
  var addToContextInDebugMode = _.io.ktor.util.debug.addToContextInDebugMode_agaij8$;
  function Coroutine$execute$lambda(closure$context_0, this$execute_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$closure$context = closure$context_0;
  ...
  Kotlin.suspendCall(addToContextInDebugMode([new PluginsTrace_init()], execute$lambda(context, $receiver), Kotlin.coroutineReceiver()));
};
}));
  ...
  package$util.EquatableAttributeKey = EquatableAttributeKey;
  ...
  package$debug.addToContextInDebugMode_agaij8$ = addToContextInDebugMode;
