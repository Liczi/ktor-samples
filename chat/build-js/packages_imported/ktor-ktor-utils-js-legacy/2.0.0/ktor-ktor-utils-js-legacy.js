(function(root, factory) {
  ...
  function AtomicOp() {
    ...
    this._consensus_6g93vj$_0 = NO_DECISION;
  }
  Object.defineProperty(AtomicOp.prototype, 'isDecided', {
  configurable: true, 
  get: function() {
  return this._consensus_6g93vj$_0 !== NO_DECISION;
}});
  ...
  return scope._consensus_6g93vj$_0 === NO_DECISION ? function() {
  scope._consensus_6g93vj$_0 = decision;
  return true;
}() : false;
})(this);
};
  AtomicOp.prototype.decide_6ronsh$_0 = function(decision) {
  return this.tryDecide_s8jyv4$(decision) ? decision : this._consensus_6g93vj$_0;
};
  AtomicOp.prototype.perform_s8jyv4$ = function(affected) {
  var tmp$, tmp$_0;
  var decision = this._consensus_6g93vj$_0;
  if (decision === NO_DECISION) {
  ...
  function LockFreeLinkedListNode() {
    this._next_4goumf$_0 = this;
    this._prev_4i0clj$_0 = this;
    this._removedRef_x8yew7$_0 = null;
  }
  LockFreeLinkedListNode.prototype.removed_kopcah$_0 = function() {
  var tmp$;
  var tmp$_0;
  if ((tmp$ = this._removedRef_x8yew7$_0) != null) 
    tmp$_0 = tmp$;
  else {
    var $receiver = new Removed(this);
    this._removedRef_x8yew7$_0 = $receiver;
    tmp$_0 = $receiver;
  }
  return tmp$_0;
};
  ...
  if (update != null && (function(scope) {
  return affected._next_4goumf$_0 === scope ? function() {
  affected._next_4goumf$_0 = update;
  return true;
}() : false;
})(this)) {
    if (success) 
  ...
  node._prev_4i0clj$_0 = this;
  node._next_4goumf$_0 = this;
  while (true) {
    var next = this.next;
    if (next !== this) 
      return false;
    if ((function(scope) {
  return scope._next_4goumf$_0 === scope ? function() {
  scope._next_4goumf$_0 = node;
  return true;
}() : false;
})(this)) {
  ...
  node._prev_4i0clj$_0 = this;
  node._next_4goumf$_0 = next;
  if (!(function(scope) {
  return scope._next_4goumf$_0 === next ? function() {
  scope._next_4goumf$_0 = node;
  return true;
}() : false;
})(this)) 
  ...
  (function(scope) {
  return scope._originalNext_0 == null ? function() {
  scope._originalNext_0 = next;
  return true;
}() : false;
})(this);
  return null;
  ...
  function LockFreeLinkedListNode$AddLastDesc(queue, node) {
    ...
    this.queue = queue;
    this.node = node;
    if (!(this.node._next_4goumf$_0 === this.node && this.node._prev_4i0clj$_0 === this.node)) {
      var message = 'Check failed.';
      throw IllegalStateException_init(message.toString());
    }
    this._affectedNode_k6zrii$_0 = null;
  }
  LockFreeLinkedListNode$AddLastDesc.prototype.takeAffectedNode_wwbkgf$ = function(op) {
  var tmp$;
  while (true) {
    var prev = Kotlin.isType(tmp$ = this.queue._prev_4i0clj$_0, LockFreeLinkedListNode) ? tmp$ : throwCCE();
    var next = prev._next_4goumf$_0;
    if (next === this.queue) 
      return prev;
    if (next === op) 
      return prev;
  ...
  configurable: true, 
  get: function() {
  return this._affectedNode_k6zrii$_0;
}});
  ...
  (function(scope) {
  return scope._affectedNode_k6zrii$_0 == null ? function() {
  scope._affectedNode_k6zrii$_0 = affected;
  return true;
}() : false;
})(this);
  return null;
  ...
  (function(scope) {
  return scope.node._prev_4i0clj$_0 === scope.node ? function() {
  scope.node._prev_4i0clj$_0 = affected;
  return true;
}() : false;
})(this);
  (function(scope) {
  return scope.node._next_4goumf$_0 === scope.node ? function() {
  scope.node._next_4goumf$_0 = scope.queue;
  return true;
}() : false;
})(this);
  return this.node;
  ...
  function LockFreeLinkedListNode$RemoveFirstDesc(queue) {
    LockFreeLinkedListNode$AbstractAtomicDesc.call(this);
    this.queue = queue;
    this._affectedNode_sdwxx1$_0 = null;
    this._originalNext_jl15jt$_0 = null;
  }
  ...
  (function(scope) {
  return scope._affectedNode_sdwxx1$_0 == null ? function() {
  scope._affectedNode_sdwxx1$_0 = affected;
  return true;
}() : false;
})(this);
  (function(scope) {
  return scope._originalNext_jl15jt$_0 == null ? function() {
  scope._originalNext_jl15jt$_0 = next;
  return true;
}() : false;
})(this);
  return null;
  ...
  if (decision != null) {
    if (decision === REMOVE_PREPARED) {
      ...
      if ((function(scope) {
  return affected._next_4goumf$_0 === scope ? function() {
  affected._next_4goumf$_0 = removed;
  return true;
}() : false;
})(this)) {
        affected.helpDelete();
      ...
      (function(scope) {
  return affected._next_4goumf$_0 === scope ? function() {
  affected._next_4goumf$_0 = scope.next;
  return true;
}() : false;
})(this);
    }
  ...
  while (true) {
    ...
    var next = affected._next_4goumf$_0;
    if (next === op) 
      return null;
    if (op.isDecided) 
      return null;
    ...
    if ((function(scope) {
  return affected._next_4goumf$_0 === next ? function() {
  affected._next_4goumf$_0 = prepareOp;
  return true;
}() : false;
})(this)) {
  ...
  if ((function(scope) {
  return affectedNode._next_4goumf$_0 === op ? function() {
  affectedNode._next_4goumf$_0 = update;
  return true;
}() : false;
})(this)) {
    if (success) 
  ...
  while (true) {
    var nextPrev = next._prev_4i0clj$_0;
    var tmp$;
    if (Kotlin.isType(nextPrev, Removed) || this.next !== next) 
      return;
    if ((function(scope) {
  return next._prev_4i0clj$_0 === nextPrev ? function() {
  next._prev_4i0clj$_0 = scope;
  return true;
}() : false;
})(this)) {
  ...
  this.helpDelete();
  next.correctPrev_c793db$_0(unwrap(this._prev_4i0clj$_0), null);
};
  ...
  while (true) {
    ...
    if ((function(scope) {
  return scope._prev_4i0clj$_0 === prev ? function() {
  scope._prev_4i0clj$_0 = removedPrev;
  return true;
}() : false;
})(this)) 
      return prev;
  ...
  var next = (Kotlin.isType(tmp$ = this._next_4goumf$_0, Removed) ? tmp$ : throwCCE()).ref;
  while (true) {
    ...
    if (Kotlin.isType(prevNext, Removed)) {
      if (last != null) {
        ...
        (function(scope) {
  return last._next_4goumf$_0 === prev ? function() {
  last._next_4goumf$_0 = prevNext.ref;
  return true;
}() : false;
})(this);
        prev = last;
        ...
        prev = unwrap(prev._prev_4i0clj$_0);
      }
      continue;
    }
    if (prevNext !== this) {
    ...
    if ((function(scope) {
  return prev._next_4goumf$_0 === scope ? function() {
  prev._next_4goumf$_0 = next;
  return true;
}() : false;
})(this)) 
      return;
  ...
  var last = null;
  while (true) {
    var prevNext = prev._next_4goumf$_0;
    if (prevNext === op) 
      return prev;
  ...
  return true;
    ...
    var oldPrev = this._prev_4i0clj$_0;
    ...
    if (oldPrev === prev) 
      return null;
    if ((function(scope) {
  return scope._prev_4i0clj$_0 === oldPrev ? function() {
  scope._prev_4i0clj$_0 = prev;
  return true;
}() : false;
})(this)) {
      if (!Kotlin.isType(prev._prev_4i0clj$_0, Removed)) 
        return null;
    }
  }
};
  LockFreeLinkedListNode.prototype.validateNode_hn3bin$ = function(prev, next) {
  if (!(prev === this._prev_4i0clj$_0)) {
    var message = 'Check failed.';
    throw IllegalStateException_init(message.toString());
  }
  if (!(next === this._next_4goumf$_0)) {
    var message_0 = 'Check failed.';
    throw IllegalStateException_init(message_0.toString());
  }
};
